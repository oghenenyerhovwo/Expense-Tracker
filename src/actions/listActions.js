...
export const getItems = () => dispatch => {
    axios
      .get("https://git.heroku.com/my-expense-tracker-react-2.git/items/")
      .then(res => {
        dispatch({
            type: GET_ITEMS,
            payload: res.data 
...
export const addItem = (form) => dispatch => (
    axios
      .post("https://git.heroku.com/my-expense-tracker-react-2.git/items/", form)
      .then(res => {
        dispatch({
            type: ADD_ITEM,
            payload: res.data,
...
export const updateItem = (form, _id) => dispatch => {
    axios
      .put("https://git.heroku.com/my-expense-tracker-react-2.git/items/" + _id, form)
      .then(res => {
        dispatch({
            type: UPDATE_ITEM,
            payload: res.data,
...
export const deleteItem = (_id) => dispatch => { 
    axios
        .delete("https://git.heroku.com/my-expense-tracker-react-2.git/items/" + _id)
        .then(res => {
            dispatch({
                type: DELETE_ITEM,
                payload: res.data,
